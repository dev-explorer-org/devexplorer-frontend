...
Vá até o diretório _`users.example`_. Copie o arquivo _`users.js.example`_ para dentro do diretório _`users`_. Agora renomeie o arquivo _`users.js.example`_ para _`seu-nome-de-usuário-do-github.js`_.
